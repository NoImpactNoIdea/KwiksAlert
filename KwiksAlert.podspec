...
Pod::Spec.new do |s|
  s.name             = 'KwiksAlert'
  s.version          = '0.1.1'
  s.summary          = 'Welcome to KwiksAlert. KwiksAlert was designed as a simple solution to manage all client facing popups for error & success handling'
...
#  s.source_files = 'KwiksAlert/Sources/**/Classes/*'

...
public class KwiksAlert : NSObject {
    ...
    public init(presentingViewController: UIViewController? = nil, popupType : PopupType? = nil) {
        ...
        if presentingViewController != nil && popupType != nil {
            ...
            //decide on copy text along with handler
    ...
    public func copyDecision(popupType : PopupType) {
        ...
        case .UpdateKwiks:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().kwiksLogo)
        ...
        case .SendingFailed:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().emailIcon)
            self.headerLabel.text = "Sending Failed!"
            self.subHeaderLabel.text = "Sending Failed. Please try again."
            self.confirmationButton.setTitle("Continue", for: .normal)
            
        case .PermissionNeeded:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().warningHollowIcon)
        ...
        case .UploadFailed:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().uploadCloudIcon)
        ...
        case .DownloadFailed:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().downloadCloudIcon)
        ...
        case .FileNotSupported:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().fileIcon)
        ...
        case .SoundNotWorking:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().soundBrokenIcon)
        ...
        case .EmailNotVerified:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().emailNotVerified)
        ...
        case .EmailVerified:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().emailVerified)
        ...
        case .VerifyPhoneNumber:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().phoneNotVerified)
            self.headerLabel.text = "Verify Phone Number!"
            self.subHeaderLabel.text = "Please verify your email to keep your account safe."
            self.confirmationButton.setTitle("Verify Now", for: .normal)
            
        case .PhoneNumberVerified:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().phoneVerified)
            self.headerLabel.text = "Phone number verified!"
            self.subHeaderLabel.text = "Your phone number  is verified successfully."
            self.confirmationButton.setTitle("Okay", for: .normal)
            
        case .IncorrectPassword:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().incorrectPasswordIcon)
        ...
        case .FailedTransaction:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().hardFailIcon)
        ...
        case .CardNotSupported:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().cardNotSupported)
        ...
        case .InsufficientBalanceLight:
            self.headerIcon.image = ImageProvider.image(named: ImageKit().moneyWalletIcon)
            self.headerLabel.text = "Insufficient Balance!"
            self.subHeaderLabel.text = "You don’t have enough balance to boost your video. Add balance to your wallet and then try again."
            self.confirmationButton.setTitle("Continue", for: .normal)
